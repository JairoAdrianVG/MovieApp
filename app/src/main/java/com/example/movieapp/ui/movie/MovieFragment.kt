...
class MovieFragment : Fragment(R.layout.fragment_movie), MovieAdapter.onMovieClickListener {
        ...
        viewModel.fetchMainScreenMovies().observe(viewLifecycleOwner, Observer { result ->
            when(result){
                ...
                is Resource.Success -> {
                    ...
                    // Usar el addAdapter para concatenar adaptadores
                    concatAdapter.apply {
                    ...
                    //Binding del recycler view para que se vea los adapters
    ...
    //Navegar para mostrar los details
    override fun onMovieClick(movie: Movie) {
        //Log.d("Click", "onMovieClick: $movie")
